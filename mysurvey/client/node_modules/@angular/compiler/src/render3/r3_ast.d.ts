...
import { AST, BindingType, BoundElementProperty, ParsedEvent, ParsedEventType } from '@angular/compiler/src/expression_parser/ast';
import { AST as I18nAST } from '@angular/compiler/src/i18n/i18n_ast';
