...
import { AST, AstMemoryEfficientTransformer, BindingPipe, LiteralArray, LiteralMap } from '@angular/compiler/src/expression_parser/ast';
...
import { R3QueryMetadata } from '@angular/compiler/src/render3/view/api';
